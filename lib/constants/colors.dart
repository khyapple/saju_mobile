...
/// 일주 색상의 테두리 색상 반환 — 수(水, 검정/남색)는 어두운 배경에서
/// 원래 색이 거의 안 보이므로 어두운 회색으로 대체
/// Returns a visible border color for day-pillar avatars: falls back to a
/// dark gray when the color is kWaterColor (nearly invisible on dark bg).
Color dayPillarBorderColor(Color base, {double opacity = 0.5}) {
  if (base == kWaterColor) {
